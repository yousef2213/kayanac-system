    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body font-main">
                ...
                <form dir="rtl" method="post" action="<?php echo e(route('offer-price.update', $invocie->id)); ?>" autocomplete="off"
                            ...
                            <select name="customerId" class="form-control chosen-select" tabindex="4" dir="rtl">
                                <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value=<?php echo e($supplier->id); ?>
                                        ...
                                        <?php echo e($invocie->customerId == $supplier->id ? 'selected' : ''); ?>>
                                    ...
                                    <tr class="Item-<?php echo e($invoiceItem->id); ?>">
                                        ...
                                        <td class="px-0">
                                            ...
                                            <input type="number" disabled
                                                name="listUpdate[<?php echo e($invoiceItem->id); ?>][total]"
                                        ...
                                        <td class="px-0">
                                            <input type="number" disabled
                                                name="listUpdate[<?php echo e($invoiceItem->id); ?>][value]"
                                        ...
                                        <td class="px-0">
                                            <input type="number" disabled
                                                name="listUpdate[<?php echo e($invoiceItem->id); ?>][nettotal]"
                                        ...
                                        <td>
                                            <button class="btn btn-danger"
                                                onclick="DeleteRowDB('<?php echo e($invoiceItem->id); ?>')" type="button"> -
                                            </button>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <table class="table table-border">
                            ...
                            <tbody class="text-center">
                                <tr>
                                    ...
                                    <td colspan="1" style="font-size: 15px" class="safe"> <?php echo e($totalVoice); ?>
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 15px" class="nettotal_inovice">
                                        <?php echo e($total - $discounts + $taxs - $invocie->taxSouceValue); ?> </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 15px" class="text-center" class="da">
                                        <input type="number" name="discountAdded" onkeyup="handelDiscountAdded(event)"
                                            ...
                                            value="<?php echo e($invocie->discount_added); ?>" style="width: 100px" step="0.1">
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 15px" class="ended"> <?php echo e($invocie->netTotal); ?> </td>
                                </tr>
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/Salles/OfferPrice/edit.blade.php ENDPATH**/ ?>