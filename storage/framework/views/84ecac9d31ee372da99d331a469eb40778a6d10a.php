    ...
    <div class="container">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <a href="<?php echo e(route('items.create')); ?>" class="btn btn-primary font-main btn-sm float-right"
                    data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"
                        style="font-size: 10px"></i> اضافة صنف
                </a>
                <a href="<?php echo e(route('file.items')); ?>" class="btn btn-primary font-main btn-sm float-right mx-2"
                    data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"
                        ...
                        <tbody>
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="text-center font-main">
                                    ...
                                    <td>
                                        <?php echo e($categorys->find($item->group) ? $categorys->find($item->group)->namear : ''); ?>
                                    ...
                                    <td class="px-0" style="width: 100px">
                                        ...
                                        ?>
                                        <?php if($item->barcodee != 0 && $item->barcodee): ?>
                                            <img src="data:image/png;base64,<?php echo e(base64_encode($generatorPNG->getBarcode($item->barcodee, $generatorPNG::TYPE_CODE_128))); ?>"
                                                height="50" width="100">
                                            <h6><?php echo e($item->barcodee); ?></h6>
                                        <?php endif; ?>
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/Items/index.blade.php ENDPATH**/ ?>