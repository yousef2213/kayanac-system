<?php $__env->startSection('main-content'); ?>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <a href="<?php echo e(route('opening_balance.create')); ?>" class="btn btn-primary font-main btn-sm float-right"
        ...
        <div class="card-header py-3">
            ...
            <h5 class="m-0 font-weight-bold text-primary float-right font-main"> <?php echo e($total); ?> </h5>
        </div>
                        ...
                        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="<?php echo e(route('opening_balance.destroy', [$item->id])); ?>">
                                        <?php echo csrf_field(); ?>
                                ...
                                <div class="modal fade" id="delModalCustomer<?php echo e($item->id); ?>" tabindex="-1"
                                    role="dialog" aria-labelledby="#delModalCustomer<?php echo e($item->id); ?>Label"
                                    aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="#delModalCustomer<?php echo e($item->id); ?>Label">
                                                    Delete user </h5>
                                            ...
                                            <div class="modal-body">
                                                <form method="post"
                                                    action="<?php echo e(route('ItemsPurchases.destroy', $item->id)); ?>">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('delete'); ?>
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/OpeneningBalance/index.blade.php ENDPATH**/ ?>