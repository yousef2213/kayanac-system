    ...
    <div class="modal-dialog" style="max-width: 800px">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="LableModalPay"> Pay Method </h5>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <form>
                            ...
                            <div class="form-group row">
                                <label for="inputPassword" class="col-sm-2 col-form-label"> MasterCard </label>
                                <div class="col-sm-10">
            ...
            <div class="modal-footer">
                <div class="d-flex justify-content-between w-100 flex-row-reverse align-items-center">
                    <div>
                        <button type="button" class="btn btn-primary" onclick="PayNow(10,'<?php echo e(csrf_token()); ?>')"
                            data-dismiss="modal">Save</button>
                        <button type="button" class="btn btn-success" onclick="PayNow(11,'<?php echo e(csrf_token()); ?>')"
...
<?php /**PATH C:\xampp\htdocs\erp\resources\views/Casher/modelPay.blade.php ENDPATH**/ ?>