    ...
    <div class="container">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary float-left font-main"> <?php echo e(__('pos.customers')); ?> </h6>
                <a href="<?php echo e(route('customers.create')); ?>" class="btn <?php echo e($orders->add == 0 ? 'd-none' : ''); ?> font-main btn-primary btn-sm float-right"
                        ...
                        <tbody>
                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="text-center font-main">
                                    ...
                                    <td><?php echo e($customer->delegName); ?></td>
                                    <td><?php echo e($customer->group); ?></td>

                                    <td class="text-center">
                                        <a href="<?php echo e(route('customers.edit', $customer->id)); ?>"
                                            class="<?php echo e($orders->edit == 0 ? 'd-none' : ''); ?> btn btn-primary btn-sm float-left mr-1" data-toggle="tooltip"
                                            title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                                        <form method="POST" class="<?php echo e($orders->delete == 0 ? 'd-none' : ''); ?>" action="<?php echo e(route('customers.destroy', [$customer->id])); ?>">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/customers/index.blade.php ENDPATH**/ ?>