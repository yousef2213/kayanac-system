        ...
        <div class="container-fluid py-4">
            <div class="row mx-0 font-main">
                <div class="col-12 col-md-10 mx-auto px-0">
                    <form dir="rtl" method="post" action="<?php echo e(route('customers.update', $custom->id)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row py-2">
                            <div class="col-12 col-md-6 mx-auto">
                                ...
                                <input type="text" name="namecustomerar" value="<?php echo e($custom->name); ?>"
                                    class="form-control" />
                            </div>
                            <div class="col-12 col-md-6 mx-auto">
                                <label>الاسم بالانجليزي</label>
                                <input type="text" name="namecustomeren" value="<?php echo e($custom->name); ?>"
                                    class="form-control" />
                            </div>
                        </div>
                            ...
                            <div class="col-12 col-md-6 mx-auto py-2">
                                <div class="form-group">
                                    ...
                                    <select name="type_invoice_electronice" class="form-control">
                                        ...
                                        <option value="B  للاعمال التجارية فى مصر" <?php echo e($custom->type_invoice_electronice == "B  للاعمال التجارية فى مصر" ? "selected" : ""); ?>>B للاعمال التجارية فى مصر</option>
                                        <option value="F  للاجنبى" <?php echo e($custom->type_invoice_electronice == "F  للاجنبى" ? "selected" : ""); ?>>F للاجنبى</option>
                                        <option value="P  للشخص الطبيعى" <?php echo e($custom->type_invoice_electronice == "P  للشخص الطبيعى" ? "selected" : ""); ?>>P للشخص الطبيعى</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 mx-auto py-2">
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/customers/edit.blade.php ENDPATH**/ ?>