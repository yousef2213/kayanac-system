<?php $__env->startSection('main-content'); ?>
    ...
    <div class="card">
        <div class="card-body font-main">
            <form method="post" dir="rtl" action="<?php echo e(route('daily.store')); ?>" autocomplete="off"
                ...
                <div class="row py-2 text-right">
                    <div class="col-12 col-md-6 mx-auto">
                        ...
                        <input type="text" autocomplete="off" disabled name="id" value="<?php echo e($id); ?>" class="form-control" />
                    </div>
                    <div class="col-12 col-md-6 mx-auto">
                        <label> التاريخ </label>
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/DailyRestrictions/create.blade.php ENDPATH**/ ?>