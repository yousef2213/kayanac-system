    ...
    <div class="card shadow mb-4">
        ...
        <div class="px-3">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control categorySelect">
                            ...
                            <?php $__currentLoopData = $categorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($category->id); ?>"> <?php echo e($category->namear); ?> </option>
            ...
            <div class="col-12 my-1 text-right">
                ...
                <form method="POST" id="myFormSalles" action="<?php echo e(route('generatePDFItems.salles')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <button type="submit" onclick="handelPrint(event)" class="btn btn-primary font-main px-4 py-1 my-3">
                        تصدير PDF </button>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script src=" <?php echo e(asset('js/ItemsReports/index.js')); ?> "></script>
                            ...
                            data.items.forEach(element => {
                                ...
                                // } else {
                                    ...
                                    <tr class="text-center font-main tdBody">
                                            ...
                                            <td class="total-item-${element.id}-${element.unit_id}-${element.item_id}-${element.price}"> ${ +element.total } </td>
                                            <td> 0 </td>
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/ItemsSalesSaved/index.blade.php ENDPATH**/ ?>