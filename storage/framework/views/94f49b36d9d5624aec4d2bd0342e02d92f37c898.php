            ...
            <div class="col-12">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        ...
                        <a href="<?php echo e(route('offer-price.create')); ?>" class="btn btn-primary font-main btn-sm float-right"
                                        ...
                                        <tr class="text-center font-main">
                                            ...
                                            <td style="width: 120px">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <a href="<?php echo e(route('offer-price.print', $Invoice->id)); ?>"
                                                        class="btn btn-info btn-sm  mr-1">
                                                        <i class="fas fa-print"></i>
                                                    </a>
                                                    <a href="<?php echo e(route('offer-price.edit', $Invoice->id)); ?>"
                                                        class="btn btn-primary btn-sm mr-1" data-toggle="tooltip"
                                                        title="edit" data-placement="bottom"><i
                                                            class="fas fa-edit"></i></a>
                                                    <form method="POST"
                                                        action="<?php echo e(route('offer-price.destroy', [$Invoice->id])); ?>">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/Salles/OfferPrice/index.blade.php ENDPATH**/ ?>