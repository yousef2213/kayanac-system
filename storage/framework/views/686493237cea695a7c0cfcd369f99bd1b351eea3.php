    ...
    <div class="card-body font-main text-right">
        ...
        <div class="form-group">
            ...
            <select name="token_serial_name" class="form-control">
                ...
                <option value="Egypt Trust" <?php echo e($company->token_serial_name == "Egypt Trust" ? 'selected' : ''); ?> >Egypt Trust</option>
                <option value="MCSD" <?php echo e($company->token_serial_name == "MCSD" ? 'selected' : ''); ?>>MCSD</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="password" name="token_pin_password" class="form-control"
                value="<?php echo e($company->token_pin_password); ?>">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="client_id" class="form-control"
                value="<?php echo e($company->client_id); ?>">
        </div>
        <div class="form-group">
            <label class="col-form-label"> Client Secret </label>
            <input type="text" name="client_secret" class="form-control"
                value="<?php echo e($company->client_secret); ?>">
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\erp\resources\views/compines/electronic_invoice.blade.php ENDPATH**/ ?>