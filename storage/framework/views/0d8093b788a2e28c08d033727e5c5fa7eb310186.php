        ...
        <div class="row">
            <nav aria-label="breadcrumb" class="">
                <ol class="breadcrumb justify-content-end font-main p-2">
                    <li class="breadcrumb-item active" aria-current="page"> الميزانية </li>
        ...
        const FormatData = res => {
            ...
            let item2 = `
                    <tr class="text-center font-main">
                        ...
                        <td class="text-danger"> ${Math.abs(+netTotalcb.toFixed(3))} </td>
                    </tr>`;
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/budget/index.blade.php ENDPATH**/ ?>