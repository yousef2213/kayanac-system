<?php $__env->startSection('main-content'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body font-main">
            ...
            <form dir="rtl" method="post" action="<?php echo e(route('salesBill.update', $invocie->id)); ?>" autocomplete="off"
                ...
                <div class="row py-2 text-right">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select name="payment" class="form-control" tabindex="4" dir="rtl">
                            <option value="1" <?php echo e($invocie->status == 1 ? 'selected' : ''); ?>> كاش </option>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        function getTotal() {
            ...
            $('.safe').text(Number(total).toFixed(2));
            $('.tax_value_plus').html(Number(taxs).toFixed(2));
    ...
    <script>
        let DeleteRowDB = async (id) => {
            swal("هل انت متاكد من حذف هذا السطر").then(res => {
                if (res) {
                    fetch('/erp/public/sales/deleteRow/' + id).then(response => response.json())
                        .then(data => {
                            if (data.status == 200) {
                                Rows = Rows.filter(el => el.id != id);
                                $(`.Item-${data.id}`).remove();
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/SalesBill/edit.blade.php ENDPATH**/ ?>