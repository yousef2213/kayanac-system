...
<script src="<?php echo e(asset('chosen.jquery.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('docsupport/prism.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('docsupport/init.js')); ?>" type="text/javascript"></script>
...
<script src=<?php echo e(asset('js/source.js')); ?>></script>
<script src=<?php echo e(asset('js/configration/index.js')); ?>></script>
<?php /**PATH C:\xampp\htdocs\erp\resources\views/dashboard/footer.blade.php ENDPATH**/ ?>