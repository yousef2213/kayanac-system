<?php $__env->startSection('main-content'); ?>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb justify-content-end font-main">
            <li class="breadcrumb-item active" aria-current="page"> تعديل امر بيع </li>
    ...
    <div class="card">
        ...
        <div class="card-body font-main">
            ...
            <form dir="rtl" method="post" action="<?php echo e(route('sell-order.update', $invocie->id)); ?>" autocomplete="off"
                ...
                <div class="row py-2 text-right">
                    <div class="col-12 col-md-6 mx-auto">
                        ...
                        <input type="text" autocomplete="off" disabled value="<?php echo e($invocie->id); ?>" name="id"
                            class="form-control" />
                    </div>
                    <div class="col-12 col-md-6 mx-auto">
                        <label> تاريخ الفاتورة </label>
                        <input type="datetime-local" autocomplete="off" value="<?php echo e($invocie->created_at); ?>"
                ...
                <div class="row py-2 text-right">
                    <div class="col-12 col-md-6 mx-auto">
                        ...
                        <select name="customerId" class="form-control chosen-select" tabindex="4" dir="rtl">
                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value=<?php echo e($supplier->id); ?>

                                    <?php echo e($invocie->customerId == $supplier->id ? 'selected' : ''); ?>> <?php echo e($supplier->name); ?>
                        ...
                        <select name="branchId" class="form-control chosen-select" tabindex="4" dir="rtl">
                            <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branche): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value=<?php echo e($branche->id); ?>
                                    ...
                                    <?php echo e($invocie->branchId == $branche->id ? 'selected' : ''); ?>>
                        ...
                        <select name="costCenter" class="form-control chosen-select" tabindex="4" dir="rtl">
                            ...
                            <?php $__currentLoopData = $costCenters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $costCenter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value=<?php echo e($costCenter->id); ?>
                                    ...
                                    <?php echo e($costCenter->id == $invocie->cost_center ? 'selected' : ''); ?>>
                                    <?php echo e($costCenter->namear); ?> </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select name="payment" class="form-control" tabindex="4" dir="rtl">
                            <option value="1" <?php echo e($invocie->status == '3' ? 'selected' : ''); ?>> كاش </option>
                            <option value="2" <?php echo e($invocie->status == 2 ? 'selected' : ''); ?>> اجل </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-12 px-0">
                    ...
                    <table class="table table-striped table-bordered mt-5">
                        ...
                        <tbody id="bodys">
                            ...
                            $totalNet = 0;
                            ?>
                            <?php $__currentLoopData = $invoiceList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoiceItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <tr class="Item-<?php echo e($invoiceItem->id); ?>">
                                    <input type="hidden" name="listUpdate[<?php echo e($invoiceItem->id); ?>][id]"
                                        value="<?php echo e($invoiceItem->id); ?>">

                                    <td class="px-0">
                                        <select name="listUpdate[<?php echo e($invoiceItem->id); ?>][storeId]"
                                            onchange="handelStore(event,'<?php echo e($invoiceItem->id); ?>')"
                                            class="form-control chosen-select">
                                            <option value="null"> --- </option>
                                            <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value=<?php echo e($store->id); ?>

                                                    <?php echo e($invoiceItem->storeId == $store->id ? 'selected' : ''); ?>>
                                                    <?php echo e($store->namear); ?> </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </td>
                                    <td class="px-0">
                                        <select name="listUpdate[<?php echo e($invoiceItem->id); ?>][itemId]"
                                            onchange="handelItem(event,'<?php echo e($invoiceItem->id); ?>')"
                                            class="form-control chosen-select">
                                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value=<?php echo e($item->id); ?>

                                                    <?php echo e($invoiceItem->item_id == $item->id ? 'selected' : ''); ?>>
                                                    <?php echo e($item->namear); ?> </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </td>
                                    <td class="px-0">
                                        <select name="listUpdate[<?php echo e($invoiceItem->id); ?>][unitId]"
                                            onchange="handelUnit(event,'<?php echo e($invoiceItem->id); ?>')"
                                            class="form-control chosen-select">
                                            <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value=<?php echo e($unit->id); ?>

                                                    <?php echo e($invoiceItem->unit_id == $unit->id || $invoiceItem->unitId == $unit->id ? 'selected' : ''); ?>>
                                                    <?php echo e($unit->namear); ?> </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </td>
                                    <td class="px-0">
                                        <input type="number" name="listUpdate[<?php echo e($invoiceItem->id); ?>][qtn]"
                                            onkeyup="handelQtn(event,'<?php echo e($invoiceItem->id); ?>')"
                                            class="form-control qtn-<?php echo e($invoiceItem->id); ?>"
                                            value="<?php echo e($invoiceItem->qtn); ?>" />
                                    </td>
                                    <td class="px-0">
                                        <input type="number" name="listUpdate[<?php echo e($invoiceItem->id); ?>][price]"
                                            onkeyup="handelPrice(event,'<?php echo e($invoiceItem->id); ?>')"
                                            class="form-control price-<?php echo e($invoiceItem->id); ?>"
                                            value="<?php echo e($invoiceItem->price); ?>" />
                                    </td>
                                    <td class="px-0">
                                        <input type="number" name="listUpdate[<?php echo e($invoiceItem->id); ?>][discount]"
                                            onkeyup="handelDiscount(event,'<?php echo e($invoiceItem->id); ?>')"
                                            class="form-control dis-<?php echo e($invoiceItem->id); ?>"
                                            value="<?php echo e($invoiceItem->discountRate); ?>" />
                                    </td>
                                    <td class="px-0">

                                        <input type="number" disabled name="listUpdate[<?php echo e($invoiceItem->id); ?>][total]"
                                            onchange="handelTotal(event,'<?php echo e($invoiceItem->id); ?>')"
                                            class="form-control total-<?php echo e($invoiceItem->id); ?>"
                                            value="<?php echo e($invoiceItem->total - $invoiceItem->discountValue); ?>" />
                                    </td>
                                    <td class="px-0">
                                        <input type="number" name="listUpdate[<?php echo e($invoiceItem->id); ?>][added]"
                                            onkeyup="handelAdded(event,'<?php echo e($invoiceItem->id); ?>')"
                                            class="form-control added-<?php echo e($invoiceItem->id); ?>"
                                            value="<?php echo e($invoiceItem->rate); ?>" />
                                    </td>
                                    <td class="px-0">
                                        <input type="number" disabled name="listUpdate[<?php echo e($invoiceItem->id); ?>][value]"
                                            onkeyup="handeltaxRate(event,'<?php echo e($invoiceItem->id); ?>')"
                                            class="form-control rate-<?php echo e($invoiceItem->id); ?>"
                                            value="<?php echo e($invoiceItem->value); ?>" />
                                    </td>
                                    <td class="px-0">
                                        <input type="number" disabled name="listUpdate[<?php echo e($invoiceItem->id); ?>][nettotal]"
                                            onkeyup="handelNetTotal(event,'<?php echo e($invoiceItem->id); ?>')"
                                            class="form-control nettotal-<?php echo e($invoiceItem->id); ?>"
                                            value="<?php echo e($invoiceItem->nettotal); ?>" />
                                    </td>

                                    <td class="px-0">
                                        <input type="number" disabled
                                            name="listUpdate[<?php echo e($invoiceItem->id); ?>][description]"
                                            onkeyup="handelNetTotal(event,'<?php echo e($invoiceItem->id); ?>')"
                                            class="form-control description-<?php echo e($invoiceItem->id); ?>"
                    ...
                    <table class="table table-border">
                        ...
                        <tbody class="text-center">
                            <tr>
                                ...
                                <td colspan="1" style="font-size: 15px" class="safe"> <?php echo e($totalVoice); ?> </td>
                            </tr>
                            <?php if($company->tax_source != 0): ?>
                                <tr>
                                    ...
                                    <td style="font-size: 15px" class="text-center" class="da">
                                        <input type="number" name="taxSource" onkeyup="handelTax(event)"
                                            ...
                                            value="<?php echo e($invocie->taxSource); ?>" style="width: 100px" id="taxSource"
                                            step="0.1">
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 15px" class="tax_value">
                                        <?php echo e(($totalVoice * $invocie->taxSource) / 100); ?></td>
                                </tr>
                            <?php endif; ?>

                            <tr>
                                <td style="font-size: 15px"> قيمة ضريبة المضافة </td>
                                <td style="font-size: 15px" class="tax_value_plus"> <?php echo e($totalTax); ?> </td>
                            </tr>

                            <tr>
                                <td style="font-size: 15px"> صافي الفاتورة </td>
                                <td style="font-size: 15px" class="nettotal_inovice">
                                    <?php echo e($totalVoice + $totalTax - ($totalVoice * $invocie->taxSource) / 100); ?> </td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        let Rows = [];
        let itemList = <?php echo json_encode($invoiceList->toArray()); ?>;
        Rows = itemList;
        const addRow = () => {
            let id = IDGenertaor();
            Rows.push({
    ...
    <script>
        let DeleteRowDB = async (id) => {
            swal("هل انت متاكد من حذف هذا السطر").then(res => {
                if (res) {
                    fetch('/erp/public/sell-order/deleteRow/' + id).then(response => response.json())
                        .then(data => {
                            if (data.status == 200) {
                                Rows = Rows.filter(el => el.id != id);
                                $(`.Item-${data.id}`).remove();
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/Salles/SellOrder/edit.blade.php ENDPATH**/ ?>