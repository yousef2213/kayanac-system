                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center priceAfterTaxVal">
                                        <?php echo e(number_format($priceAfterTaxVal, 4, '.', '')); ?> </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center totalTaxRate">
                                        <?php echo e(number_format($totalTaxRate, 4, '.', '')); ?>

                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-right"> اجمالي </th>
                                    <td class="text-center netTotal"> <?php echo e($netTotal); ?> </td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <tbody class="">
                    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="text-center font-main" style="text-align: center">
                            <td style="text-align: center"> <?php echo e($order['item_name']); ?> </td>
                            <td style="text-align: center"> <?php echo e($order['unit_name']); ?> </td>
                            <td style="text-align: center"> <?php echo e($order['qtn']); ?> </td>
                            <td style="text-align: center"> <?php echo e(number_format($order['price'], 3, '.', '')); ?>

                            </td>
                            <td style="text-align: center"> <?php echo e($order['total']); ?> </td>
                            <td style="text-align: center"> 0 </td>
                            <td style="text-align: center">
                                <?php echo e(number_format($order['value'], 3, '.', '')); ?> </td>
                            <td style="text-align: center"> <?php echo e($order['nettotal']); ?> </td>
                        </tr>
...
<?php /**PATH C:\xampp\htdocs\erp\resources\views/ItemsSalesSaved/Pdf.blade.php ENDPATH**/ ?>