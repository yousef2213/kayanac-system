    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-end font-main">
                <li class="breadcrumb-item active" aria-current="page"> اضافة عرض سعر </li>
        ...
        <div class="card">
            ...
            <div class="card-body font-main">
                <form method="post" dir="rtl" action="<?php echo e(route('offer-price.store')); ?>" autocomplete="off"
                        ...
                        <table class="table table-border">
                            ...
                            <tbody class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 15px" class="text-center" class="da">
                                        <input type="number" name="discountAdded" onkeyup="handelDiscountAdded(event)"
                                            class="form-control text-center d-inline-block disAded" style="width: 100px" step="0.1">
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 15px" class="ended">00</td>
                                </tr>
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/Salles/OfferPrice/create.blade.php ENDPATH**/ ?>