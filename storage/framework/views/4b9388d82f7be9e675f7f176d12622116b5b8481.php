    ...
    <div class="container">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <a href="<?php echo e(route('assembly.create')); ?>" class="btn btn-primary font-main btn-sm float-right"
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" id="items-dataTable" dir="rtl" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $itemCollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="text-center font-main">
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('items-collection.edit', $item->id)); ?>"
                                            class="btn btn-primary btn-sm float-left mr-1" data-toggle="tooltip"
                                            title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                                        <form method="POST" action="<?php echo e(route('items-collection.destroy', [$item->id])); ?>">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/ItemsCollection/assembly/index.blade.php ENDPATH**/ ?>