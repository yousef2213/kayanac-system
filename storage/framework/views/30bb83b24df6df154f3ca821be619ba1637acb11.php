            ...
            <div class="col-12 mx-auto">
                <form action="" dir="rtl">
                    ...
                    <div class="text-right my-4">
                        <button class="btn bg-main px-5" onclick="Show(event, '<?php echo e(csrf_token()); ?>')"> عرض </button>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/IncomeList/index.blade.php ENDPATH**/ ?>