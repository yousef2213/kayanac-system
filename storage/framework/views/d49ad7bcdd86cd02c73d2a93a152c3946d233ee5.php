<?php $__env->startSection('main-content'); ?>
    ...
    <div class="card">
        <div class="card-body font-main">
            <form method="post" dir="rtl" action="<?php echo e(route('opening_balance_accounts.update', $invoice->id)); ?>"
                ...
                <div class="row py-2 text-right">
                        ...
                        <select name="branchId" class="form-control chosen-select" tabindex="4" dir="rtl">
                            <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branche): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value=<?php echo e($branche->id); ?>
                                    ...
                                    <?php echo e($branche->id == $invoice->branchId ? 'selected' : ''); ?>> <?php echo e($branche->namear); ?>
                        ...
                        <table class="table table-border">
                            ...
                            <tbody class="text-center">
                                <tr>
                                    ...
                                    <td colspan="1" style="font-size: 15px" class="md"> <?php echo e($debtors); ?>

                                    </td>
                                </tr>
                                <tr>
                                    <td style="font-size: 15px"> اجمالي الدائن </td>
                                    <td style="font-size: 15px" class="da"> <?php echo e($credetors); ?> </td>
                                </tr>
                                <tr>
                                    <td style="font-size: 15px"> الفرق </td>
                                    <td style="font-size: 15px" class="def"> <?php echo e($debtors - $credetors); ?> </td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="col-12 px-0">
                        ...
                        <table class="table table-striped table-bordered mt-5">
                            ...
                            <tbody id="bodys">
                                <?php $__currentLoopData = $invoicesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <input type="hidden" name="listUpdate[<?php echo e($item->id); ?>][id]"
                                        value="<?php echo e($item->id); ?>">
                                    <tr class="Item-<?php echo e($item->id); ?>">
                                        <td class="px-0">
                                            <select name="listUpdate[<?php echo e($item->id); ?>][account_id]"
                                                class="form-control chosen-select w-100">
                                                <option value="null"> --- </option>
                                                <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value=<?php echo e($account->account_id); ?>

                                                        <?php echo e($account->account_id == $item->account_id ? 'selected' : ''); ?>>
                                                        <?php echo e($account->name); ?> </option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </td>
                                        <td class="px-0">
                                            <input type="number" onkeyup="handeldebtor(event,'<?php echo e($item->id); ?>')"
                                                name="listUpdate[<?php echo e($item->id); ?>][debtor]" step="0.1"
                                                value="<?php echo e($item->debtor); ?>"
                                                class="form-control debtor-<?php echo e($item->id); ?>" />
                                        </td>
                                        <td class="px-0">
                                            <input type="number" onkeyup="handelcreditor(event,'<?php echo e($item->id); ?>')"
                                                name="listUpdate[<?php echo e($item->id); ?>][creditor]" step="0.1"
                                                value="<?php echo e($item->creditor); ?>"
                                                class="form-control creditor-<?php echo e($item->id); ?>" />
                                        </td>
                                        <td class="px-0">
                                            <input type="text" name="listUpdate[<?php echo e($item->id); ?>][description]"
                                                value="<?php echo e($item->description); ?>"
                                                class="form-control dis-<?php echo e($item->id); ?>" />
                                        </td>

                                        <td>
                                            <button class="btn btn-danger" onclick="DeleteRow('<?php echo e($item->id); ?>')"
                                                type="button"> -
                                            </button>
                                        </td>
                                    </tr>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        let Rows = <?php echo json_encode($invoicesList->toArray()); ?>;;
        const addRow = () => {
            let id = IDGenertaor();
            Rows.push({
                id
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/OpeneningBalanceAccounts/edit.blade.php ENDPATH**/ ?>