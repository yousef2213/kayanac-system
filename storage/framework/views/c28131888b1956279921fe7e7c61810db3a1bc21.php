<?php $__env->startSection('main-content'); ?>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="<?php echo e(route('permission_add.create')); ?>" class="btn btn-primary font-main btn-sm float-right"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post"
                                                    action="<?php echo e(route('permission_add.delete', $Invoice->id)); ?>">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/PermissionAdd/index.blade.php ENDPATH**/ ?>