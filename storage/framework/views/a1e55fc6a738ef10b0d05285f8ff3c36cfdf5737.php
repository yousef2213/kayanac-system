                ...
                <div class="d-flex justify-content-between w-100 flex-row-reverse align-items-center">
                    <div>
                        <button type="button" class="btn btn-primary"
                            onclick="PayNowResturant(10,'<?php echo e(csrf_token()); ?>')" data-dismiss="modal">Save</button>
                        <button type="button" class="btn btn-success"
                            onclick="PayNowResturant(2,'<?php echo e(csrf_token()); ?>')" data-dismiss="modal">Credit</button>
                ...
                <div class="d-flex justify-content-between w-100 flex-row-reverse align-items-center">
                    <div>
                        <button type="button" class="btn btn-primary" data-dismiss="modal"
                            onclick="CreateCustomer('<?php echo e(csrf_token()); ?>')">حفظ</button>
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<?php /**PATH C:\xampp\htdocs\erp\resources\views/POS/PayModel.blade.php ENDPATH**/ ?>