            ...
            <div class="col-10 mx-auto">
                <div class="py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="font-main text-center"><?php echo e($company->companyNameAr); ?></h6>
                            <h6 class="font-main text-center text-uppercase"><?php echo e($company->active); ?></h6>
                        </div>
                        <div>
                            <img src="<?php echo e(asset('comp/'.$company->logo)); ?>" class="rounded" width="100" alt="">
                        </div>
                        <div>
                            <h6 class="font-main text-center text-uppercase"><?php echo e($company->companyNameEn); ?></h6>
                            <h6 class="font-main text-center text-uppercase"><?php echo e($company->active); ?></h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center flex-row-reverse py-3">
                    <div class="d-flex justify-content-between">
                        ...
                        <h6 class="mx-3 font-main"> <?php echo e(date('d / m / Y', strtotime($bond->date))); ?> م</h6>
                    </div>
                    <div class="d-flex justify-content-between">
                        
                        <div class="text-center">
                            <span class="span-title font-main rel"> <?php echo e($currency->bigar); ?> </span>
                            
                            <div class="box">
                                <h6> <?php echo e($item->amount); ?> </h6>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\erp\resources\views/bond/print.blade.php ENDPATH**/ ?>