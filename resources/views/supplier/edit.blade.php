    ...
    <div class="container-fluid py-4">
        <div class="row mx-0 font-main">
            <div class="col-12 col-md-10 mx-auto px-0">
                <form dir="rtl" method="post" action="{{ route('supplier.update', $custom->id ) }}">
                    {{ csrf_field() }}
                    @method('PATCH')
                        ...
                        <div class="col-12 col-md-6 mx-auto">
                            ...
                            <div class="form-group">
                                ...
                                <select name="group" class="form-control">
                                    ...
                                    <option value="1" {{$custom->group == "1" ? 'selected'  :  "" }}>مجموعة رئيسية</option>
                                </select>
                                @error('status')
                    ...
                    <div class="row py-2 font-main">
                        <div class="col-12 col-md-6 mx-auto">
                            ...
                            <input type="number" name="numRegister" value="{{$custom->VATRegistration}}" class="form-control"  />
                        </div>
                        <div class="col-12 col-md-6 mx-auto">
                            <label>تلفون</label>
                    ...
                    <div class="row py-2 font-main">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="number" name="IdentificationNumber" value="{{$custom->IdentificationNumber}}" class="form-control"  />
                        </div>
                        <div class="col-12 col-md-6">
                            <label> العنوان </label>
                            <input autocomplete="off" type="text" value="{{$custom->address}}"  name="address" class="form-control"  />
                            @error('address')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
