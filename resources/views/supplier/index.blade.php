    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-end font-main p-2">
                <li class="breadcrumb-item active" aria-current="page"> {{ __('pos.suppliers') }} </li>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary float-left">{{ __('pos.suppliers') }}</h6>
                <a href="{{ route('supplier.create') }}"
                    ...
                    data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"
                        style="font-size: 10px"></i>{{ __('pos.addSupplier') }} </a>
            </div>
            <div class="card-body">
                            ...
                            @foreach ($customers as $customer)
                                <tr class="text-center font-main">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('supplier.edit', $customer->id) }}"
                                        ...
                                        <form method="POST" class="{{ $orders->delete == 0 ? 'd-none' : '' }}"
                                            action="{{ route('supplier.destroy', [$customer->id]) }}">
                                            @csrf
                                            @method('delete')
