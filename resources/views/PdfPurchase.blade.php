                ...
                <tbody class="">
                    @foreach ($InvoicesDetails as $order)
                        <tr class="text-center font-main" style="text-align: center">
                            ...
                            <td style="text-align: center"> {{ $units->find($order->unitId)->namear }} </td>
                            <td style="text-align: center" class="">
                                {{ $order->qtn }}
                            </td>
                            <td style="text-align: center">
                                {{ number_format((float) $order->price - $order->TaxVal, 2, '.', '') }} </td>

                            <td style="text-align: center"> {{ number_format((float) $order->TaxVal, 2, '.', '') }}
                            </td>
