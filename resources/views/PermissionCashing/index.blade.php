    ...
    <div class="container">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <a href="{{ route('permission_cashing.create') }}" class="{{ $orders->add == 0 ? 'd-none' : '' }} btn btn-primary font-main btn-sm float-right"
                    ...
                    <table class="table table-bordered" id="salesInvoice-dataTable" dir="rtl" width="100%" cellspacing="0">
                        ...
                        <tbody class="bodyTableSales">
                            @foreach ($Invoices as $Invoice)
                                ...
                                <td> كاش </td> --}}
                                    {{-- <td>
                                    <form method="POST" action="{{ route('permission_cashing.delete', [$Invoice->id]) }}">
                                        @csrf
                                        @method('delete')
