...
@section('main-content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb justify-content-end font-main">
            <li class="breadcrumb-item active" aria-current="page"> اضافة اذن اضافة </li>
            <li class="breadcrumb-item"><a href="/erp/public/permission_add"> اذن اضافة </a></li>
    ...
    <div class="card">
        ...
        <div class="card-body font-main">
            <form method="post" dir="rtl" action="{{ route('permission_add.store') }}" autocomplete="off"
                ...
                <div class="row py-2 text-right">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select name="storeId" class="form-control chosen-select" tabindex="4" dir="rtl">
