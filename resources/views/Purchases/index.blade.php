    ...
    <div class="container">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                ...
                <a href="{{ route('ItemsPurchases.create') }}" class="{{ $orders->add == 0 ? 'd-none' : '' }} btn btn-primary font-main btn-sm float-right"
                        ...
                        <tbody class="bodyTableSales text-center">
                            @foreach ($purchases as $purchase)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('ItemsPurchases.edit', $purchase->id) }}"
                                        ...
                                        <form method="POST" class="{{ $orders->delete == 0 ? 'd-none' : '' }}"
                                            action="{{ route('ItemsPurchases.destroy', [$purchase->id]) }}">
                                            @csrf
                                            @method('delete')
