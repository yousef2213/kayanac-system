    ...
    <div class="container">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                <h6 class="font-main m-0 font-weight-bold text-primary float-left"> {{ __('pos.customers') }} </h6>
                <a href="{{ route('crm-customers.create') }}" class="btn  font-main btn-primary btn-sm float-right"
                            ...
                            @foreach ($customers as $customer)
                                <tr class="text-center font-main">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('crm-customers.edit', $customer->id) }}"
                                            class="btn btn-primary btn-sm float-left mr-1" data-toggle="tooltip"
                                            title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                                        <form method="POST"
                                            action="{{ route('crm-customers.destroy', [$customer->id]) }}">
                                            @csrf
                                            @method('delete')
