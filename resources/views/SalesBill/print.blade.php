                ...
                <div class="pt-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h6 class="font-main text-right text-uppercase">{{ $customer->customer }}</h6>
                        </div>
                        <div>
                    ...
                    <table class="table font-main table-border">
                        ...
                        <tbody class="text-center">
                            <tr>
                                ...
                                <td colspan="1" style="font-size: 15px" class="safe"> {{ $total1 }}
                                </td>
                            </tr>
                            <tr>
                                <td style="font-size: 15px"> ضريبة القيمة المضافة </td>
                                <td style="font-size: 15px" class="tax_value_plus"> {{ $total2 }} </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 15px" class="nettotal_inovice">
                                    {{ $total1 + $total2 - $taxSouceValue - $discounts }} </td>
                            </tr>
                        </tbody>
                    </table>
                </div>
