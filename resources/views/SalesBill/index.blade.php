                                        ...
                                        <tr class="text-center font-main">
                                            ...
                                            <td style="width: 120px">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <a href="{{ route('salesBill.edit', $Invoice->id) }}"
                                                        class="{{ $orders->edit == 0 ? 'd-none' : '' }} btn btn-primary btn-sm mr-1" data-toggle="tooltip"
                                                        title="edit" data-placement="bottom"><i
                                                            class="fas fa-edit"></i></a>
                                                    <form method="POST"
                                                        class="{{ $orders->delete == 0 ? 'd-none' : '' }}"
                                                        action="{{ route('salesBill.destroy', [$Invoice->id]) }}">
                                                        @csrf
                                                        @method('delete')
