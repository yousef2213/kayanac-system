    ...
    <div class="card shadow mb-4">
            ...
            <form>
                <div class="form-row align-items-center flex-row-reverse">
                    ...
                    <div class="col-12 my-1 text-right">
                        <button type="submit" onclick="filterDate(event)" class="btn btn-primary font-main px-3"> بحث
                        </button>
                    </div>
                </div>
            </form>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="salesInvoice-dataTable2" dir="rtl" width="100%" cellspacing="0">
                    <thead>
                ...
                success: function(data) {
                    ...
                    data.orders.forEach(element => {
                        ...
                        <tr class="text-center font-main">
                                ...
                                <td>
                                    ${ element.payment == 1 ? " كاش <br /> " : '' }
                                    ${ element.masterCard == 2 ? "اجل <br />" : '' }
                                </td>
