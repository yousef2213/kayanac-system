...
@section('main-content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb justify-content-end font-main">
            ...
            <li class="breadcrumb-item"><a href="/erp/public/returnedInvoices"> مرتجع المشتريات </a></li>
    ...
    <div class="card">
        ...
        <div class="card-body font-main">
            ...
            <form dir="rtl" method="post" action="{{ route('returnedInvoices.update', $purchase->id) }}"
                        ...
                        <tbody id="bodys">
                            @foreach ($purchaseList as $purchaseitem)
                                <tr class="Item-{{ $purchaseitem->id }}">
                                    ...
                                    <td class="px-0">
                                        <input type="number" disabled name="listUpdate[{{ $purchaseitem->id }}][added]"
        ...
        const addRow = () => {
            ...
            let item = `
                <tr class="Item-${id}">
                    ...
                    <td class="px-0">
                        <input type="number" disabled name="added" onkeyup="handelAdded(event,'${id}')" value="0" class="form-control added-${id}" />
                    </td>
                    <td class="px-0">
