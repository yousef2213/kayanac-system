                                ...
                                <table class="table" dir="rtl">
                                    <tbody>
                                        ...
                                        @if ($company->tobacco_tax == 1)
                                            <tr class="isTab3">
                                                <th class="text-right"> ضريبة التبغ </th>
                                                <td class="text-center tobacco_tax"> 00 </td>
                                            </tr>
                                        @endif
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    data.orders.forEach(calc => {
                        ...
                        credit += calc.credit;
                        tobacco_tax += calc.tobacco_tax || 0;
                    });
                    ...
                    data.orders.forEach(element => {
                        ...
                        var datestring = d.getDate() + "-" + (d.getMonth() + 1) + "-" + d
                            .getFullYear() + " " +
                    ...
                    $('.finalTotal').text(net);
                    $('.priceAfterTaxVal').text(+(net - taxRateTotal).toFixed(2));
                    $('.delever').text(+delever);
                    $('.tobacco_tax').text(+tobacco_tax.toFixed(2));
